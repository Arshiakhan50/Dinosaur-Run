...
class Dino:
    def __init__(self):
        ...
        new_width = self.dino_image.get_width() // 1.3
        new_height = self.dino_image.get_height()

        # Resize the dino image
        self.dino_image = pygame.transform.scale(self.dino_image, (new_width, new_height))
